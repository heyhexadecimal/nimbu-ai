...
-- AddForeignKey
ALTER TABLE "public"."Message" ADD CONSTRAINT "Message_threadId_fkey" FOREIGN KEY ("threadId") REFERENCES "public"."Conversation"("threadId") ON DELETE CASCADE ON UPDATE CASCADE;
